...
import com.marlee.myblog.common.RandStringUtils;
...
public class LoginController extends BaseController{
    ...
    @ResponseBody
    public Map<String,Object> sendSms(Model model, @RequestParam(value = "telephone",required = false) final String telephone ) {
