            ...
            <div class="tab-pane fade in active" id="account-login">
                <div class="content" >
                    <div class="col-sm-6 col-sm-offset-3 col-md-4 col-sm-offset-4 login-box" style="width: 450px;height: 260px;">
                        ...
                        <form id="normal_form" name="form" role="form" class="login-form" action="${path}/profile" method="post">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="${path}/index_list">首页</a></li>
            ...
            <ul class="nav navbar-nav">
                <li><a href="${path}/writedream">写梦</a></li>
            </ul>

            <ul class="nav navbar-nav" style="margin-left: 680px">
                <li>
                    <a style="float: left" href="${path}/list">
...
<div class="author-card follow-box">
    ...
    <div class="dreamland-see" id="dreamland-see" style="margin-top: 510px">
        ...
        <div class="author clearfix" style="margin-left: 10px">
            <div>
                <a href="/users/31123326/" target="_blank" rel="nofollow" style="height: 50px" onclick="">
                     <img src="/assets/images/icon_m.jpg">
                </a>
            </div>
        ...
        <div class="author clearfix" style="margin-left: 10px">
            <div>
                <a href="/users/31123326/" target="_blank" rel="nofollow" style="height: 50px" onclick="">
                     <img src="${path}/assets/images/icon_m.jpg">
                </a>
            </div>
            <a href="/users/31123326/" target="_blank" onclick="" >
                <h2 class="author-h2">
        ...
        <ul style="font-size: 12px" id="release-dreamland-ul">
            <c:forEach var="cont" items="${page.result}" varStatus="i">
                <li class="dreamland-fix">
                    <a href="${path}/watch?cid=${cont.id}">${cont.title}</a>
    ...
    <div id="update-dreamland" style="height: 700px;margin-top: 50px;width: 100%;display: none" >
        <ul style="font-size: 12px" id="update-dreamland-ul">
            <c:forEach var="cont" items="${page.result}" varStatus="i">
                <li class="dreamland-fix">
                    <a href="${path}/watch?cid=${cont.id}">${cont.title}</a>
                    <a href="${path}/deleteContent?cid=${cont.id}"><span class="bar-delete">删除</span></a>
                    <a href="${path}/writedream?cid=${cont.id}"><span class="bar-update">修改</span></a>
                    <hr/>
                </li>
            </c:forEach>
...
<div class="ibx-advice" onmouseover="changeBackColor();" onmouseout="back2color();">
    <a href="${path}/writedream"><span class="glyphicon glyphicon-edit" aria-hidden="true" style="color:#1b1b1b;font-size:30px;" title="写梦"></span></a>
</div>
                ...
                if(pageCate=="fail"){
                    ...
                    if(ucList!=null){
                        $(ucList).each(function () {
                            var contHtml = "<li class='dreamland-fix'><a href='${path}/watch?cid="+this.id+"'>"+this.title+"</a> <span class='bar-read'>评论 ("+this.commentNum+")</span>"
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(pageCate=="fail"){
                    ...
                    if(ucList!=null) {
                        $(ucList).each(function () {
                            var contHtml = " <li class='dreamland-fix'> <a href='${path}/watch?cid="+this.id+"'>"+this.title+"</a><a href='${path}/deleteContent?cid="+this.id+"'><span class='bar-delete'>删除</span></a>"
                                +"<a href='${path}/writedream?cid="+this.id+"'><span class='bar-update'>修改</span></a><hr/></li>";
                            startHtml = startHtml + contHtml;
                        });
                        var okHtml = startHtml + endHtml;
