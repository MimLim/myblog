...
<c:set var="path" value="${pageContext.request.contextPath }"/>     <%--用于设置变量值和对象属性--%>
<html>
<head>
    <meta charset="UTF-8">
    <title>注册</title>
    ...
    <link type="text/css" rel="stylesheet" href="${path}/assets/css/dreamland.css">
    ...
    <div class="zhuce_kong" id="dre_div">
        <div class="zc">
            <div class="bj_bai" id="regist-left" style="height: 468px">
                <h3>欢迎注册</h3>
                <form action="${path}/doRegister" method="post" id="registerForm">
            ...
            <div id="regist-right" class="bj_right" style="height: 468px">
                <p>使用以下账号直接登录</p>
                <div>
                    <a href="to_login"><img src="${path}/assets/images/Connect_logo_3.png" /></a>
                </div>
