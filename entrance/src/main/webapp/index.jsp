...
<head>
    ...
    <link rel="stylesheet" href="${path}/assets/css/reply/css/style.css">
    <link rel="stylesheet" href="${path}/assets/css/reply/css/comment.css">
...
<div class="container">
    ...
    <div class="header-img" style="position: absolute;margin-left: 920px;margin-top: -40px;">
        <c:if test="${empty user}">
            <a href="to_login"><img src="${path}/assets/images/Connect_logo_7.png"></a>
            &nbsp;&nbsp;
        ...
        <c:if test="${not empty user}">
            <div class="header-user-img">
                ...
                &nbsp;&nbsp;
                <a name="tj_login" class="lb" href="${path}/loginout" style="color: black">[退出]</a>
            </div>
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${path}/index_list">首页</a>
        </div>
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#">问答</a></li>
                <li><a href="#">我的</a></li>
                <li><a href="${path}/list?id=${user.id}">个人空间</a></li>
            </ul>
        </div>

        <form method="post" action="${path}/index_list"  id="indexSearchForm"  class="navbar-form navbar-right" role="search" style="margin-top: -35px;margin-right: 10px">
        ...
        <div class="col-md-9"  style="background-color: white;">
            ...
            <div id="page-info" style="position: absolute;width:900px;background-color: #EBEBEB;height: 80px;left: 0px;">
                <ul class="pager pager-loose">
                    ...
                    <c:if test="${page.pageNum > 1}">
                        <li class="previous"><a href="${path}/index_list?pageNum=${page.pageNum-1}&&keyword=${keyword}">« 上一页</a></li>
                    </c:if>
                    <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pn">
                        ...
                        <c:if test="${page.pageNum!=pn}">
                            <li ><a href="${path}/index_list?pageNum=${pn}&&keyword=${keyword}">${pn}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${page.pageNum<page.pages}">
                        <li><a href="${path}/index_list?pageNum=${page.pageNum+1}&&keyword=${keyword}">下一页 »</a></li>
                    </c:if>
                            ...
                            <li>
                                <a href="http://www.dreamland.wang" onMouseOut="hideImg()"  onmouseover="showImg()">
                                    ...
                                    <div id="wxImg" style="display:none;height:50px;back-ground:#f00;position:absolute;">
                                        <img src="/assets/images/dreamland.png"/><br/>
                                        手机扫描二维码关注
                                    </div>
...
<script type="text/javascript" src="${path}/assets/css/reply/js/jquery.flexText.js"></script>
...
<script language=javascript>
    ...
    function personal(uId) {
        this.location =  "${path}/list?id="+uId;
    }
