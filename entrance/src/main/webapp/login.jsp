...
<head>
    ...
    <link href="${paht}/assets/css/zui/lib/uploader/zui.uploader.min.css" rel="stylesheet">
                ...
                <div class="tab-pane fade" id="phone-login">
                    <form role="form" class="login-form form-horizontal" id="phone_form" action="${ctx}/phoneLogin"
                        ...
                        <div class="form-group">
                            <label for="password" class="sr-only">密码</label>
                            <div class="col-xs-6">
                                <input type="text" id="verifyCode" name="phone_code" class="form-control"
                                       placeholder="验证码" onclick="checkPhoneCode();">
                            </div>
                            <div class="col-xs-6">
...
<script src="${path}/assets/css/zui/js/zui.min.js"></script>
<script>
    //校验用户名
